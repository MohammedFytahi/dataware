...
<h2 class=" text-center font-bold m-10"> Mes information personnel</h2>
...
<div class="container mx-auto bg-white p-8 rounded-md shadow-md">
    ...
    try {
        ...
        $contenuClient = mysqli_query($con, 'SELECT * FROM users');

        if ($contenuClient === false) {
            throw new Exception('Erreur d\'exécution de la requête : ' . mysqli_error($con));
        }
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead>
                <tr>
                    ...
                    <th class="px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Prenom</th>
    ...
    <a href='modifier.php?id=<?= $ligne['id'] ?>' class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2">
        Modifier
    </a>
    <a href='delete.php?id=<?= $ligne['id'] ?>' class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
        Supprimer
    </a>
</td>
