...
<?php
$nomMess = $prenomMess = $emailMess = $passwordMess = '';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!preg_match("/^[a-zA-Z]+[a-zA-Z0-9]*$/", $prenom)) {
        $prenomMess = 'Format de prénom invalide !!';
    }
    ...
    if (empty($nomMess) && empty($prenomMess) && empty($emailMess)) {
        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form method="POST" class="space-y-4 md:space-y-6" action="valid.php">
                        <div>
